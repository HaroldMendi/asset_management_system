                        ...
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                          <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                            <div class="overflow-hidden">
                              <form action="{{ route('asset-tag.store') }}" method="POST">
                                @csrf
				                        <input type="hidden" name="asset_id" value="{{ $asset[0]->id }}">
                                <!-- Serial Number -->
                                <div class="col-span-6 sm:col-span-4">
                                  <x-label for="title" value="{{ __('Serial Number') }}" />
                                  <x-input id="serial_number" name="serial_number" type="text" class="mt-1 block w-full"/>
                                 ...
                                 <div class="col-span-6 sm:col-span-4">
                                  ...
                                  <x-input id="asset_tag_number" name="asset_tag_number" type="text" class="mt-1 block w-full"/>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                  ...
                                  <x-input id="other_information" name="other_information" type="text" class="mt-1 block w-full"/>
                                 ...
                                 <div class="col-span-6 sm:col-span-4">
                                  ...
                                  <x-input id="purchase_price" name="purchase_price" type="text" class="mt-1 block w-full"/>
